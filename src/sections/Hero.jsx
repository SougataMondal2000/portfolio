    ...
    <div className="lg:h-[650px] lg:p-4 h-full p-10 w-full flex items-center justify-center">
      <div className="h-auto w-full lg:w-[1000px]">
        ...
        <div className="pt-12 pb-10 justify-center flex text-center">
          <h1 className="leading-none text-[#588157] font-bold text-[60px] lg:text-[80px] animate-fade-down animate-duration-1000 animate-delay-100">
            Web Wizardry by Sougata!
          </h1>
        </div>
        <div className="items-center justify-center flex gap-3 h-fit animate-fade-up animate-duration-1500 animate-delay-100">
